...
<div class="container my-3">
    <form action="/board_con/write_action" method="post">
        ...
        <div class="my-1">
            <input type="text" required class="form-control w-25  mg-auto input_box inline" name="userID" id="" value="<?=$writer?>">
            <input type="password" required class="form-control w-25  mg-auto input_box inline" name="userPass" id="" placeholder="비밀번호를 입력해주세요.">
        </div>
...
<div class="container my-3">
    <form action="/board_con/write_action" method="post">
        ...
        <div class="my-1">
            <input type="text" required class="form-control w-25  mg-auto input_box inline" name="userID" id="" placeholder="아이디">
            <input type="password" required class="form-control w-25  mg-auto input_box inline" name="userPass" id="" placeholder="비밀번호">
        </div>
