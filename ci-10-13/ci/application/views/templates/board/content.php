...
<div class="container content_box">
    ...
    <p class="content_top2">
        ...
        <button class="btn btn-primary me-3" onclick="board_confirm('modify')">수정하기</button>
        <input type="password" id="b_modify_pass" class="hidden" style="margin-left : -15px;">
        ...
        <input type="password" id="b_remove_pass" class="hidden">
...
<? foreach ($comments as $comment) : ?>
    ...
    <? } ?>
        <p>
            ...
            <input type="button" id="c_modify_btn_<?=$comment['c_seq']?>" data-c_seq="<?=$comment['c_seq']?>" class="hidden btn btn-primary comment_change" value="수정">
        </p>
